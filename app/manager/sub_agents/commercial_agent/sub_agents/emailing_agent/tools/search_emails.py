"""
Search emails tool for Gmail integration.
"""
...
def search_emails(
    ...
    Args:
        query (str): Gmail search query (e.g., "from:example@gmail.com", "subject:meeting", "is:unread")
    ...
    try:
        ...
        return {
            "status": "success",
            "message": f"Found {len(formatted_emails)} email(s) matching query: {query}",
