"""
Add user tool for Firestore integration.
"""

from database_utils import db, serialize_firestore_value
from datetime import datetime

def add_user(fullname :str , email :str , phone :str = None , zone :str = None , planId :str = None , subscriptionStatus :str = None ) -> dict:
    """
